    ...
    return (
        <ScrollView style={tw`${dark ? 'bg-[#1E1E1E]' : 'bg-white'}`}>
            ...
            <View style={tw`p-4`}>
                ...
                <Text style={tw`mb-4 text-justify ${dark ? 'text-white' : 'text-black'}`}>
                ...
                <Text style={tw`text-lg font-semibold mb-2 ${dark ? 'text-white' : 'text-black'}`}>1. Use of the App</Text>
                <Text style={tw`mb-4 text-justify ${dark ? 'text-white' : 'text-black'}`}>
                ...
                <Text style={tw`text-lg font-semibold mb-2 ${dark ? 'text-white' : 'text-black'}`}>2. Privacy Policy</Text>
                <Text style={tw`mb-4 text-justify ${dark ? 'text-white' : 'text-black'}`}>
                    Your privacy is important to us. Please review our Privacy Policy to understand how we collect, use, and protect your personal information.
                </Text>

                <Text style={tw`text-lg font-semibold mb-2 ${dark ? 'text-white' : 'text-black'}`}>3. User Accounts</Text>
                <Text style={tw`mb-4 text-justify ${dark ? 'text-white' : 'text-black'}`}>
                    You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account.
                </Text>

                <Text style={tw`text-lg font-semibold mb-2 ${dark ? 'text-white' : 'text-black'}`}>4. Changes to Terms</Text>
                <Text style={tw`mb-4 text-justify ${dark ? 'text-white' : 'text-black'}`}>
                ...
                <Text style={tw`text-lg font-semibold mb-2 ${dark ? 'text-white' : 'text-black'}`}>5. Contact Us</Text>
                <Text style={tw`mb-4 text-justify ${dark ? 'text-white' : 'text-black'}`}>
                ...
                <Text style={tw`mt-6 text-sm text-center text-gray-500`}>
                    © 2025 SocialMediaAiAgent. All rights reserved.
                </Text>
            </View>
        </ScrollView>
    );
